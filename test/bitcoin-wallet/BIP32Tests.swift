...
struct BIP32Tests {
    ...
    @Test func vector1() throws {
        ...
        #expect(xprvM == expectedXprv)
        let xpubM = try Wallet.neuterHDPrivateKey(key: xprvM)
        #expect(xpubM == expectedXpub)
        ...
        #expect(xprvM0h == expectedXprv)
        let xpubM0h = try Wallet.neuterHDPrivateKey(key: xprvM0h)
        #expect(xpubM0h == expectedXpub)
        ...
        #expect(xprvM0h1 == expectedXprv)
        var xpubM0h1 = try Wallet.neuterHDPrivateKey(key: xprvM0h1)
        #expect(xpubM0h1 == expectedXpub)
        ...
        #expect(xprvM0h12h == expectedXprv)
        var xpubM0h12h = try Wallet.neuterHDPrivateKey(key: xprvM0h12h)
        #expect(xpubM0h12h == expectedXpub)
        #expect(throws: WalletError.attemptToDeriveHardenedPublicKey) {
        ...
        #expect(xprvM0h12h2 == expectedXprv)
        var xpubM0h12h2 = try Wallet.neuterHDPrivateKey(key: xprvM0h12h2)
        #expect(xpubM0h12h2 == expectedXpub)
        ...
        #expect(xprvM0h12h21000000000 == expectedXprv)
        var xpubM0h12h21000000000 = try Wallet.neuterHDPrivateKey(key: xprvM0h12h21000000000)
        #expect(xpubM0h12h21000000000 == expectedXpub)
    ...
    @Test func vector2() throws {
        ...
        #expect(xprvM0 == expectedXprv)
        let xpubM0 = try Wallet.neuterHDPrivateKey(key: xprvM0)
        #expect(xpubM0 == expectedXpub)
        ...
        #expect(xprvM0h27h == expectedXprv)
        let xpubM0h27h = try Wallet.neuterHDPrivateKey(key: xprvM0h27h)
        #expect(xpubM0h27h == expectedXpub)
        ...
        #expect(xprvM0h27h1 == expectedXprv)
        var xpubM0h27h1 = try Wallet.neuterHDPrivateKey(key: xprvM0h27h1)
        #expect(xpubM0h27h1 == expectedXpub)
        ...
        #expect(xprvM0h27h126h == expectedXprv)
        let xpubM0h27h126h = try Wallet.neuterHDPrivateKey(key: xprvM0h27h126h)
        #expect(xpubM0h27h126h == expectedXpub)
        ...
        #expect(xprvM0h27h126h2 == expectedXprv)
        var xpubM0h27h126h2 = try Wallet.neuterHDPrivateKey(key: xprvM0h27h126h2)
        #expect(xpubM0h27h126h2 == expectedXpub)
    ...
    @Test func vector4() throws {
        ...
        #expect(xprvM0h1h == expectedXprv)
        let xpubM0h1h = try Wallet.neuterHDPrivateKey(key: xprvM0h1h)
        #expect(xpubM0h1h == expectedXpub)
    }
