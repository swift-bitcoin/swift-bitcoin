...
struct BIP350Tests {
    ...
    func ecToAddressCommand() throws {
        ...
        let pubkey = try #require(PublicKey(compressed: [0x02, 0xd6, 0x88, 0x9c, 0xb0, 0x81, 0x03, 0x6e, 0x0f, 0xae, 0xfa, 0x3a, 0x35, 0x15, 0x7a, 0xd7, 0x10, 0x86, 0xb1, 0x23, 0xb2, 0xb1, 0x44, 0xb6, 0x49, 0x79, 0x8b, 0x49, 0x4c, 0x30, 0x0a, 0x96, 0x1d]))
    ...
    func scriptToAddressCommand() throws {
        // Adding 0x02 to the internal public key here to make it a standard public key.
        let pubkeyData = Data([0x02, 0xf9, 0xf4, 0x00, 0x80, 0x3e, 0x68, 0x37, 0x27, 0xb1, 0x4f, 0x46, 0x38, 0x36, 0xe1, 0xe7, 0x8e, 0x1c, 0x64, 0x41, 0x76, 0x38, 0xaa, 0x06, 0x69, 0x19, 0x29, 0x1a, 0x22, 0x5f, 0x0e, 0x8d, 0xd8])
        let pubkey = try #require(PublicKey(compressed: pubkeyData))
        let script1Data = Data([0x20, 0x44, 0xb1, 0x78, 0xd6, 0x4c, 0x32, 0xc4, 0xa0, 0x5c, 0xc4, 0xf4, 0xd1, 0x40, 0x72, 0x68, 0xf7, 0x64, 0xc9, 0x40, 0xd2, 0x0c, 0xe9, 0x7a, 0xbf, 0xd4, 0x4d, 0xb5, 0xc3, 0x59, 0x2b, 0x72, 0xfd, 0xac])
        let script2Data = Data([0x07, 0x54, 0x61, 0x70, 0x72, 0x6f, 0x6f, 0x74])
        let script1 = try Script(binaryData: script1Data)
        let script2 = try Script(binaryData: script2Data)
