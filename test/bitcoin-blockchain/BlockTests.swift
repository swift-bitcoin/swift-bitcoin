...
struct BlockTests {
    ...
    func genesisBlock() async throws {
        ...
        let genesisBlockRedeserialized = try Block(binaryData: genesisBlockData)
    ...
    func block1() async throws {
        ...
        let expectedBlock = try Block(binaryData: expectedBlockData)
        ...
        let expectedCoinbaseTx = try Transaction(binaryData: expectedCoinbaseTxData)
    ...
    func blockDateNanoseconds() throws {
        ...
        let blockRoundTrip = try Block(binaryData: emptyBlock.binaryData)
