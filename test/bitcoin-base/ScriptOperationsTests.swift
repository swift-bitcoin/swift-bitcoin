...
struct ScriptOperationsTests {
    ...
    @Test("Cryptographic operations", arguments: [
        // ripemd160
        ([helloData], [Script.Operation.ripemd160], [expectedRIPEMD160]),
        // sha1
    ...
    func cryptographyOps(initialStack: [Data], ops: [Script.Operation], finalStack: [Data]) throws {
        var stack = initialStack
        try Script(ops).run(&stack)
        #expect(stack == finalStack)
    }
    ...
    @Test("Stack operations", arguments: [
        ...
        ([1], [Script.Operation.toAltStack, .zero, .fromAltStack], [0, 1]),
        // ifDup
