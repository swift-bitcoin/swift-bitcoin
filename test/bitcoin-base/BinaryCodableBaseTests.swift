...
struct BinaryCodableBaseTests {
    ...
    @Test func hashOuts() throws {
        ...
        let hashOuts = Data([0xa2, 0xe6, 0xda, 0xb7, 0xc1, 0xf0, 0xdc, 0xd2, 0x97, 0xc8, 0xd6, 0x16, 0x47, 0xfd, 0x17, 0xd8, 0x21, 0x54, 0x1e, 0xa6, 0x9c, 0x3c, 0xc3, 0x7d, 0xcb, 0xad, 0x7f, 0x90, 0xd4, 0xeb, 0x4b, 0xc5])

        let outsData = outs.reduce(Data()) { $0 + $1.binaryData }
        let shaOuts = Data(SHA256.hash(data: outsData))

        #expect(shaOuts == hashOuts)
        ...
        let data = encoder.data
        let shaOuts2 = Data(SHA256.hash(data: data))
        #expect(shaOuts2 == shaOuts)
