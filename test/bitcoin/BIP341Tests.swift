...
struct BIP341Tests {
    ...
    func scriptPubKey(
        ...
        let (tweakedPubkey, _) = createTapTweak(internalKey: Data(givenInternalPubkey), merkleRoot: merkleRoot)
        ...
        #expect(merkleRoot == (auxMerkleRoot == .none ? Data?.none : Data(auxMerkleRoot!)))
