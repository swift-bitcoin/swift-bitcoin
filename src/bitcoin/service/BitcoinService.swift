...
public actor BitcoinService: Sendable {
    ...
    public func generateTo(_ address: String, blockTime: Date = .now) {
        ...
        let coinbaseTx = BitcoinTransaction.makeCoinbaseTransaction(blockHeight: blockTransactions.count, destinationPublicKeyHash: destinationPublicKeyHash, witnessMerkleRoot: witnessMerkleRoot, consensusParams: consensusParams)
