...
public struct BitcoinTransaction: Equatable, Sendable {
    ...
    static func makeGenesisTransaction(consensusParams: ConsensusParams) -> Self {
        ...
        let genesisTx = BitcoinTransaction(
            ...
            outputs: [
                .init(value: consensusParams.blockSubsidy,
                      script: .init([
    ...
    static func makeCoinbaseTransaction(blockHeight: Int, destinationPublicKeyHash: Data, witnessMerkleRoot: Data, consensusParams: ConsensusParams) -> Self {
        ...
        let coinbaseTx = BitcoinTransaction(version: .v2, inputs: [
            ...
            .init(value: consensusParams.blockSubsidy, script: .init([
                .dup,
                .hash160,
