...
public class Environment {
    ...
    public init(path: FilePath, flags: Flags = [], maxDBs: UInt32? = nil, maxReaders: UInt32? = nil, mapSize: size_t? = nil) throws {
        self.path = path
        self.flags = flags
        ...
        let envOpenStatus = mdb_env_open(handle, path.description.cString(using: .utf8), UInt32(flags.rawValue), fileMode)
